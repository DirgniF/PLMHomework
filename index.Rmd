...
Next, we partition the trainingdata in a training set and a validation set. We will use this to estimate out-of-sample error rates.
...
We therefore apply this svm model on the 20 test samples, and obtain a 20/20 score.
